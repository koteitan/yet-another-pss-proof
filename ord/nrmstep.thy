...
lemma seam_open_blift:
  ...
  shows "sibrel (mrun Y a) (drop (Suc b) Y
           @ map (\<lambda>j. (entry M 0 j + m * d0, entry M 1 j)) [j0..<j1])"
  sorry
  (* TODO sibrel4: proof temporarily frozen (was green pre-sibrel4; the
     lxf-case inner sibrel_diverge consumption needs a branch-4 escape at
     the lxf level - memo 続68補2/補3.  Statement TRUE under sibrel4:
     sibm2 closure+3 audit 0/729131.  Full proof in git history. *)
