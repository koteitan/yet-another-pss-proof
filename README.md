...
- koteitan, "[pss-proof](https://github.com/koteitan/pss-proof)". (formalization of P進大好きbot's proof; its ordinal-free syntactic well-foundedness proof of $\mathrm{OT}$ is the blueprint for the route used here)
